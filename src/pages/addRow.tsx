    ...
    const selectForm = (module: string) => {
        switch(module){
            case 'Cuadro de ventas':
                return <CuadroVentasForm is_update={data_state.isEdit} update_values={data_state.isEdit ? data : {}}row={data_state.id}/>;
            case 'Cartera':
                return <CarteraForm is_update={data_state.isEdit} update_values={data_state.isEdit ? data : {}}row={data_state.id}/>;
            case 'Cuentas bancarias':
                return <CuentasForm is_update={data_state.isEdit} update_values={data_state.isEdit ? data : {}}row={data_state.id}/>;
            case 'Cuentas por pagar':
                return <CuentaPendienteForm is_update={data_state.isEdit} update_values={data_state.isEdit ? data : {}}row={data_state.id}/>;
            case 'Flujo de caja':
                return <FlujoCajaForm is_update={data_state.isEdit} update_values={data_state.isEdit ? data : {}}row={data_state.id}/>;
            default:
                return <RegistroVentasForm is_update={data_state.isEdit} update_values={data_state.isEdit ? data : {}}row={data_state.id}/>;
        }
    }
