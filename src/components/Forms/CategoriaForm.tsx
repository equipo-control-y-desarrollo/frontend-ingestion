...
const CategoriasForm = (props: FormProps): ReactElement => {
  ...
  const validationSchema = Yup.object({
    ...
    transferencia: Yup.number().required("Esto campo es obligatorio").min(0),
      ...
      >
        <Form id="moduleForm">
          <div className="add-view-field">
            <label htmlFor="flujo_caja_id">ID del Flujo de caja</label>
            <Field
              name="flujo_caja_id"
              type="number"
            ...
            />
            <ErrorMessage name="flujo_caja_id" render={renderError} />
          </div>
          <div className="add-view-field">
