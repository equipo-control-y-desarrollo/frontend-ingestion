...
const CuadroVentasForm = (props: FormProps): ReactElement => {
    ...
    <div className="form-container">
      ...
      >
        <Form id="moduleForm">
          ...
          <div className="add-view-field">
            <label htmlFor="ventas_ma_ana">Ventas de la mañana</label>
            <Field
              name="ventas_ma_ana"
              type="number"
              className="input-field-add"
            ...
            ></Field>
            <ErrorMessage name="ventas_ma_ana" render={renderError} />
          </div>
          <div className="add-view-field">
            ...
            <Field
              ...
              placeholder="Ingrese la cantidad de ventas"
            ></Field>
            <ErrorMessage name="ventas_tarde" render={renderError} />
          </div>
          <div className="add-view-field">
          ...
          <div className="add-view-field">
            <label htmlFor="transferencia">Cantidad por transferencia</label>
            <Field
              name="transferencia"
              type="number"
              className="input-field-add"
            ...
            />
            <ErrorMessage name="transferencia" render={renderError} />
          </div>
          <div className="add-view-field">
          ...
          <div className="add-view-field">
            <label htmlFor="ventas_mercado">Ventas del mercado</label>
            <Field
              name="ventas_mercado"
              type="number"
              className="input-field-add"
            ...
            />
            <ErrorMessage name="ventas_mercado" render={renderError} />
          </div>
          <div className="add-view-field">
            <label htmlFor="gastos_caja_menor">Gastos caja menor</label>
            <Field
            ...
            />
            <ErrorMessage name="gastos_caja_menor" render={renderError} />
          </div>
          <div className="add-view-field">
          ...
          <div className="add-view-field">
            ...
            />
            <ErrorMessage name="horas_reserva" render={renderError} />
          </div>
        </Form>
      </Formik>
    </div>
