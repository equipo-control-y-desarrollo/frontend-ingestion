...
const CuadroVentasForm = ({is_update, update_values, row}: {is_update: boolean, update_values: {}, row: string}) => {
            ...
            >
                <Form>
                    ...
                    <div className="add-view-field">
                        ...
                        <ErrorMessage name="ventas_manana" render={renderError}/>
                    </div>
                    <div className="add-view-field">
                        <label htmlFor='ventas_tarde'>
                            Ventas de la tarde
                        </label>
                        <Field
                            name="ventas_tarde"
                    ...
                    <div className="add-view-field">
                        <label htmlFor='datafono'>
                            Cantidad en datafono
                        </label>
                        <Field
                            name="datafono"
                            type="number"
